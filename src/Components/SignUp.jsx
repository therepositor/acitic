        ...
        <div className='sign-up'>
            ...
            <div className="sign-up-bg">
                ...
                <div className="sign-up-form">
                    <p>To get started, you need to first have an existing business. <span>Create Account</span></p>
                    <form action="">
                        ...
                        <div className="form-group">
                            <input placeholder='Website URL' type='url' id='website_url' name='website_url' />
                        </div>
                        ...
                        <div className="form-group-checkbox">
                            ...
                            <p><small>By clicking this, you have agreed to our <Link to='terms_and_condition'>Terms and Conditions</Link> and <Link to='privacy_policy'>Privacy Policy</Link></small></p> 
                        </div>
                        <div className="form-group-submit"><input type="submit" value="Get Started" /></div>
                    </form>
                    <div className="alt-sign-up">
                        <p>
                            Already  have an account? <Link to='/sign_in' className='sign-up-navLink'>Sign In</Link> <br />
                            or sign up with <br />
                        </p>
                        <div>
                        <span>
