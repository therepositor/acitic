...
const BuildStageQuestionnaire = ({ handleQuestionnaireChange }) => {
    
    const handleQuestionnaireSubmit = (e) =>    {
        e.preventDefault();
        window.location.href = '/build_stage_questionnaire_feedback';
    }
    return (
        <div className='build-questionnaire'>
...
export default BuildStageQuestionnaire
